  ...
  pub fn new(color: &'static Color) -> Self {
    ...
    Self {
      pieces: vec![
        ...
        Piece { piece_type: PieceType::Bishop, color: color, pos: (1, pos) },
        Piece { piece_type: PieceType::Knight, color: color, pos: (2, pos) },
        Piece { piece_type: PieceType::Queen, color: color, pos: (3, pos) },
        Piece { piece_type: PieceType::King, color: color, pos: (4, pos) },
        Piece { piece_type: PieceType::Knight, color: color, pos: (5, pos) },
        Piece { piece_type: PieceType::Bishop, color: color, pos: (6, pos) },
